...
namespace ExercicisProva
{
    class ClaseMain
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("5. Exercicis Cadenes");
            Console.WriteLine("6. Exercicis Classes/funcions");
        ...
        static void ExercicisCadenes()
        {
            ...
            {
                case 1:
                    Exercicis_cadenes.Exercici1();
                    break;
                case 2:
                    Exercicis_cadenes.Exercici2();
                    break;
                case 3:
                    Exercicis_cadenes.Exercici3();
                    break;
            }
        }

        static void ExercicisClassesFuncions()
        {
            Console.WriteLine("Triar l'exercici que vol probar");
            Console.WriteLine("Exercicis 1");
            Console.WriteLine("Exercicis 2");
            ...
            {
                case 1:
                    Exercicis_ClassesFuncions.Exercici1();
                    break;
                case 2:
                    Exercicis_ClassesFuncions.Exercici2();
                    break;
                case 3:
                    Exercicis_ClassesFuncions.Exercici3();
                    break;
            }
        }
    }
